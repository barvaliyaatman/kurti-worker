    ...
    <div className="space-y-5 font-sans select-none max-w-7xl mx-auto">
      ...
      {!isLoading && !isError && (
        <>
          ...
          <div className="bg-white p-4 rounded-2xl border border-slate-100 shadow-xs flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
              <h3 className="text-xs font-bold text-slate-400 uppercase tracking-widest">Quick Operations</h3>
              <p className="text-[11px] text-slate-500 mt-0.5">Instant actions for manufacturing workflows.</p>
            </div>
              ...
              {quickActions.map((action) => {
                ...
                return (
                  <button
                    ...
                    className="flex items-center gap-1.5 px-3 py-1.5 bg-slate-50 hover:bg-indigo-50 border border-slate-200 hover:border-indigo-200 text-slate-700 hover:text-indigo-700 text-xs font-semibold rounded-lg transition-colors cursor-pointer"
                  >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
            ...
            <Card className="p-4 space-y-3 border border-slate-100 shadow-xs">
              ...
              {recentJobCards.length > 0 ? (
                ...
                <EmptyState title="No Job Cards" description="Created production batches will display here." />
              )}
            </Card>
            ...
            <Card className="p-4 space-y-3 border border-slate-100 shadow-xs">
              ...
              {recentPayments.length > 0 ? (
                ...
                <EmptyState title="No Payments" description="Payment history will display here." />
              )}
            </Card>
          </div>
        </>
